...
<section id="home" class="s-home page-hero target-section" data-parallax="scroll"
    data-image-src="{{asset('stellar/images/hero-bg.jpg')}}" data-natural-width=3000 data-natural-height=2000
    ...
    <div class="home-content" style="vertical-align: top; padding-top:15.6rem;">
        ...
        <div class="row home-content__main">
            ...
            <form method="POST" class="group mc-form" action="{{route('undn.check')}}">
                @csrf
            ...
            <?php if (isset($undian)) {?>
            <a href="{{route('undn')}}" style="color: white"><i class="fas fa-undo-alt fa-2x"></i></a>
            <?php } ?>
